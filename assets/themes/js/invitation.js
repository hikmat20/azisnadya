         ...
         $.ajax({
            ...
            success: function (result) {
               ...
               if (result.code == 1) {
                  ...
                  const greet =
                     `<div class="slick-slide slick-cloned slick-current slick-active"><div><div class="px-3">
                        <div class="card shadow-sm text-theme-primary" style="background-color:#ffd6d6 ;border-radius: 1rem;background-position: top center;background-repeat: repeat-y;background-size: cover;">
                     ...
                     result.name +
                     `</span>
                      <span class="badge badge-sm font-size-10 text-sm bg-warning">Baru</span>
...
var countDownDate = new Date("Dec 24, 2022 08:00:00").getTime();
